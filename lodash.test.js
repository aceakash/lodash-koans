/******************************************************************************/
/*  SPOILER ALERT: This file has all the solutions, use only as last resort.  */
/******************************************************************************/
...
describe('Easy - needs a single lodash function, with optional scalar arguments', function () {
  it('#1', function () {
    ...
    var actual = _.drop(input, 2);   // <----- Edit this line
  ...
  it('#6', function () {
    ...
    var actual = _.fromPairs(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#7', function () {
    ...
    var actual = _.differenceBy(input1, input2, 'id');   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#8', function () {
    ...
    var actual = _.chunk(input, 2);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#9', function () {
    ...
    var actual = _.fill(input, '-', 2, 5);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#10', function () {
    var input = [4, 5, 7, 8];
    var expected = 4;
    var actual = _.first(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#11', function () {
    ...
    var actual = _.flattenDeep(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#12', function () {
    ...
    var actual = _.compact(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#13', function () {
    ...
    var actual = _.join(input, '-');   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#14', function () {
    ...
    var actual = _.intersection(input1, input2, input3);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#15', function () {
    var input = [6, [4, 5], 3, 8, [2, 1, [0, 7]]];
    var expected = [6, 4, 5, 3, 8, 2, 1, [0, 7]];
    var actual = _.flatten(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#16', function () {
    ...
    var actual = _.difference(input1, input2);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#17', function () {
    ...
    var actual = _.initial(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#18', function () {
    ...
    var input2 = 5;
    var expected = 4;
    var actual = _.lastIndexOf(input1, input2);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#19', function () {
    ...
    var actual = _.reverse(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#20', function () {
    ...
    var expected = 4;
    var actual = _.sortedIndex(input1, input2);   // <----- Edit this line
    actual.must.eql(expected);
  });
  ...
  it('#21', function () {
    ...
    var actual = _.tail(input);   // <----- Edit this line
    actual.must.eql(expected);
  });
});
